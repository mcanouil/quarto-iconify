...
local CASES = {
  ...
  { 'color: red !important', 'red', 'an important marker' },
  { 'color: red!important', 'red', 'an important marker with no space' },
  { 'color: red !IMPORTANT', 'red', 'an upper-case important marker' },
  { 'color: !important', '', 'an important marker and no value' },
  { 'background-color: red !important', '', 'a decoy with an important marker' },
